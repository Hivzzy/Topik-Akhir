...
@section('container')
    <div class="space-y-4 sm:space-y-6">
        ...
        <div class="bg-white p-4 space-y-6 rounded shadown-md">
            <form method="POST" action="/akun/tambah">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="grid grid-rows-1">
                        <label class="font-medium" for="">Nama</label>
                        <input class="px-2 py-1 border bg-gray-100 border-1 rounded" type="text" name="nama_user">
                    </div>
                    <div class="grid grid-rows-1">
                    ...
                    <div class="grid grid-rows-1">
                        ...
                        <input class="px-2 py-1 border bg-gray-100 border-1 rounded" type="text" name="username">
                    </div>
                    <div class="grid grid-rows-1">
