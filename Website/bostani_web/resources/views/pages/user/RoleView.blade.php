            ...
            <div class="flex justify-between items-center">
                <a href="#"
                    ...
                    <div class="flex space-x-1 items-center">
                        ...
                        <span class="hidden sm:block">Tambah Role</span>
                    </div>
                </a>
                <div>
                    <div class="flex w-full flex-wrap items-stretch">
                        <input type="search"
                            ...
                            placeholder="Cari role" aria-label="Search" aria-describedby="button-addon1" />
                                ...
                                <tbody>
                                    @foreach ($roles as $role)
                                        <tr class="border-b">
                                            ...
                                            <td class="whitespace-nowrap px-6 py-4">{{ $role->nama_role }}</td>
