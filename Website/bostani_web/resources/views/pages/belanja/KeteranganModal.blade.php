...
@foreach ($items as $item)
    <div data-te-modal-init
        ...
        id="updateInformationModal{{ $item->order_id }}{{ $item->product_id }}" tabindex="-1" aria-labelledby="updateInformationLabel" aria-hidden="true" aria-modal="true">
        <div data-te-modal-dialog-ref
            ...
            <div
                ...
                <div class="relative flex-auto p-4" data-te-modal-body-ref>
                    <form action="/keterangan/update/{{ $item->order_id }}/{{ $item->product_id }}" method="POST">
                        @csrf
