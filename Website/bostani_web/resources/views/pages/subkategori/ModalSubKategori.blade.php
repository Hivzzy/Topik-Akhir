...
<div data-te-modal-init
    ...
    id="addSubCategoryModal" tabindex="-1" aria-labelledby="addSubCategoryLabel" aria-hidden="true" aria-modal="true">
    <div data-te-modal-dialog-ref
        ...
        <div
            ...
            <div
                ...
                <!--Modal title-->
                <h5 class="text-xl font-medium leading-normal">Tambah Sub Kategori</h5>
                <!--Close button-->
                <button type="button"
            ...
            <div class="relative flex-auto p-4" data-te-modal-body-ref>
                <form action="/subkategori/tambah" method="POST">
                    @csrf
...
@foreach ($sub_categories as $sub_category)
    <div data-te-modal-init
        class="fixed left-0 top-0 z-[1055] hidden h-full w-full overflow-y-auto overflow-x-hidden outline-none"
        id="editSubCategoryModal{{ $sub_category->id }}" tabindex="-1" aria-labelledby="editSubCategoryLabel"
        ...
        <div data-te-modal-dialog-ref
            ...
            <div
                ...
                <div
                    class="flex flex-shrink-0 items-center justify-between rounded-t-md border-b-2 border-neutral-100 border-opacity-100 p-4 dark:border-opacity-50">
                    <!--Modal title-->
                    <h5 class="text-xl font-medium leading-normal">Edit Sub Kategori</h5>
                    <!--Close button-->
                    <button type="button"
                        class="box-content rounded-none border-none hover:no-underline hover:opacity-75 focus:opacity-100 focus:shadow-none focus:outline-none"
                        data-te-modal-dismiss aria-label="Close">
                ...
                <!--Modal body-->
                <div class="relative flex-auto p-4" data-te-modal-body-ref>
                    <form action="/subkategori/edit/{{ $sub_category->id }}" method="POST">
                        @csrf
                        <div class="grid grid-cols-1 gap-2">
