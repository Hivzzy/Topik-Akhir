...
<nav id="sidebar"
    ...
    <ul class="relative m-0 list-none px-[0.2rem]" data-te-sidenav-menu-ref>
        ...
        @endif
        <li class="relative">
            <a class="{{ $active === 'account' ? 'flex items-center w-full h-12 px-3 mt-2 font-medium text-[#27272A] bg-white rounded' : 'flex items-center w-full h-12 px-3 mt-2 font-medium rounded hover:bg-gray-700 text-white' }}"
                href="/akun/edit-user">
                <x-icons.users />
